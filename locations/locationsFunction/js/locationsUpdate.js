...
module.exports.locationsUpdate = async (event) => {
    console.log(event);
    const params = event.body;

    let update;
    let updateSet = "";
    const idLocations = params.idLocations;
    params['locationDateUpdate'] = 'NOW()';
    ...
    update = `UPDATE locations SET ` + updateSet + ` WHERE idLocations = ` + idLocations + ';';
